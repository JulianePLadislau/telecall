  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li class="dropdown"><a class="active" href="index.php">Início<i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="index.php#cpaas">CPaaS</a></li>
              <li><a href="index.php#uso">Usos</a></li>
              <li><a href="index.php#vantagens">Vantagens</a></li>
              <li><a href="index.php#clientes">Nosssos Clientes</a></li>
            </ul>
          </li>

          <li class="dropdown"><a href="2fa.php">2FA<i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="2fa.php#2fa">2FA</a></li>
              <li><a href="2fa.php#como-funciona">Como funciona?</a></li>
              <li><a href="2fa.php#beneficio">Benefícios</a></li>
              <li><a href="2fa.php#quem-usa">Quem usa?</a></li>
            </ul>
          </li>

          <li class="dropdown"><a href="numero.php">Número Máscara<i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="numero.php#numero">Número Máscara</a></li>
              <li><a href="numero.php#como-funciona">Como funciona?</a></li>
              <li><a href="numero.php#quem-usa">Quem usa?</a></li>
              <li><a href="numero.php#recursos">Recursos Avançados</a></li>
            </ul>
          </li>

          <li class="dropdown"><a href="google.php">Google Verified Calls<i class="bi bi-chevron-down"></i></a>
              <ul>
                <li><a href="google.php#problema">O Problema</a></li>
                <li><a href="google.php#oque">o que é?</a></li>
                <li><a href="google.php#compatibilidade">Compatibilidade</a></li>
                <li><a href="google.php#como-funciona">Como funciona?</a></li>
                <li><a href="google.php#beneficios">Benefícios</a></li>
                <li><a href="google.php#usos">Usos</a></li>
              </ul>
          </li>
          
          </li>
          <li class="dropdown"><a href="sms.php">SMS Programável<i class="bi bi-chevron-down"></i></a>
            <ul>  
              <li><a href="sms.php#oquee">O que é?</a></li>
              <li><a href="sms.php#usos">Quem usa?</a></li>
              <li><a href="sms.php#jornada">Jornada do Cliente</a></li>
              <li><a href="sms.php#beneficios">Benefícios</a></li>
            </ul>
          </li>
          
             
          <li class="dropdown"><a href="">Login<i class="bi bi-chevron-down"></a></i></a>
              <ul>
                <li><a href="frm_login.html">Comum</a></li>
                <li><a href="frm_login_m.html">Master</a></li>
